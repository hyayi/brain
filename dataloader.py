...
class BrainDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage = None):
        ...
        train_transform = TestCompose([AddChannel() , Spacing(pixdim=(1, 1, 2)),CropOrPad((256, 256, 48)),RandAdjustContrast(),ZNormalization(masking_method=tio.ZNormalization.mean),EnsureType()])
        val_transform =  TestCompose([AddChannel(), Spacing(pixdim=(1, 1, 2)),CropOrPad((256, 256, 48)),ZNormalization(masking_method=tio.ZNormalization.mean),EnsureType()])
